...
// const mensaje = "gato perro perro coche Gato peRRo sol";
...
function contarPalabras(mensaje) {
  // Convierte todas las palabras del mensaje a minúsculas y las divide en un array
  const palabras = mensaje.toLowerCase().split(' ')

  // Crea un objeto para contar las palabras
  const contador = {}
